      ...
      <div class="content-area">
        ...
        <section class="overview">
          ...
          <div class="search-container">
            ...
            <input type="text" id="brandSearch" placeholder="Search brand..." onkeyup="filterBrands(this.value)">
          </div>
              ...
              <tbody>
                <?php
                  ...
                  while ($row = mysqli_fetch_assoc($res)) {
                    ...
                    $rowClass = $row['Is_Active'] ? 'active-row' : 'inactive-row';
                    echo "<tr class='$rowClass'>
                            ...
                            <td class='action-btns'>
                              ...
                              <i class='fas fa-trash' onclick='deleteBrand({$row['Brand_Id']})'></i>
                            </td>
                          </tr>";
                  }
                ?>
